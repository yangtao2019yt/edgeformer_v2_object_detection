    ...
    def _make_mix_layer(self, block: Type[Union[BasicBlock, Bottleneck]], planes: int, blocks: int, gcc_bs_index: int,
        ...
        for i in range(1, blocks):
            if i < gcc_bs_index:
                ...
                layers.append(GCC_block(self.inplanes, planes, global_kernel_size = global_kernel_size,
...
@register_model
def res50_gcc(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    model = resnet(Bottleneck, [3, 4, 6, 3], [3, 4, 3, 2], **kwargs)
    # test
